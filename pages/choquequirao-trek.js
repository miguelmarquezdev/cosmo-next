...
export default function Choquequirao({ categories }) {
  ...
  return (
    <Layout
      title={"Choquequirao Trek tours - Cosmo Expeditions"}
      description={
    ...
    >
      ...
      <div
        className={`bg-choquequirao w-full h-96 relative bg-no-repeat bg-cover ${styles.bgfondo}`}
      >
        <div
        ...
        >
          <h1 className={`text-white font-semibold text-4xl text-center`}>
            Choquequirao Trek <span className={`${styles.cirulo}`}></span>
          </h1>
        </div>
