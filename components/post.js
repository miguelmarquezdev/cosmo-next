...
export default function Post({ post }) {
  console.log(post)
  return (
    <article className={`grid grid-cols-1 sm:grid-cols-1 md:grid-cols-12 lg:grid-cols-12 gap-4 ${styles.post} items-center mb-16`}>
      <div className={`${styles.contExcerpt} col-span-5 z-10`}>
        <h3 className="font-bold text-xl w-3/5 capitalize">{post.title.rendered}</h3>
